  ...
  return (
    <div className="quiz--container container">
      <div className="button--container">
        <button onClick={handleShownClick} className="button--style quiz--button shadow-sm">Κεφάλαιο {props.id}</button>
      </div>
      {triggerMessage ?  (
      isCorrectShow ? (
        <div className="center">
          <div className="alert alert-success alert-dismissible shadow-sm" role="alert">
        ...
        <div className="center">
          <div className="alert alert-danger alert-dismissible shadow-sm" role="alert">
      ...
      {shown ? (
        showScore? (
          <div className="score--section  quiz--container--questions container shadow">
            <h2>Απάντησες {tempScore} από τις {props.class.length} ερωτήσεις σωστά!</h2> 
          </div>
          ) : (
            <div className=" quiz--container--questions container shadow">
              <h1 className="center classNum">Κεφάλαιο {props.id}</h1>
              <div className="question--section">
                  <h2 className="center">Ερώτηση {props.class[currentQuestion].id} </h2>
                  <p className="center">{props.class[currentQuestion].questionText}</p>
              </div>
          ...
          <div className=" quiz--container--after"></div>
          )}
    </div>
  );
};
